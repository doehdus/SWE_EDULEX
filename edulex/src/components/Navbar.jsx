...
import { Library, NotebookText, FlaskConical, BarChart2, LogOut, KeyRound } from 'lucide-react'
  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-6 py-5 flex flex-col gap-3" style={{ borderTop: `1px solid ${LIB.parchmentDark}` }}>
          <button
