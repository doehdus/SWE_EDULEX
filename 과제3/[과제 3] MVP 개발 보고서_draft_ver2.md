...
| H04 | PDF → AI 단어장 생성 | 사용자는 PDF를 업로드하여 AI가 자동 생성한 단어장을 즉시 만들 수 있다. | Supabase Edge Function + OpenAI API, 단어장 2개 초과 시 생성 차단 | High |
...
| H04 | PDF → AI 단어장 생성 | PdfUploadBar.jsx, Edge Function create-wordbook-from-pdf | ⚠️ 부분 완료 | - |
